...
### Changed
- Clean homepage URL (removed UTM tracking parameters)

## [1.0.1] - 2026-01-27

### Added
- Homepage link in package.json pointing to sanny.dev/plugins/
- README badges for npm version, downloads, and license
...
[1.0.2]: https://github.com/sannysri/wp-headless-client/releases/tag/v1.0.2
[1.0.1]: https://github.com/sannysri/wp-headless-client/releases/tag/v1.0.1
